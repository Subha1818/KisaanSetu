...
export const DashboardBackground: React.FC<DashboardBackgroundProps> = ({ variant }) => {
  return (
    <div className="hidden md:block fixed inset-0 pointer-events-none z-[-1] overflow-hidden bg-slate-50">
      ...
      {variant === 'admin' ? (
        <>
          {/* Left illustration: Layered curves, Amber Seal, Audit Clipboard & Administrative Columns */}
          <svg className="absolute top-32 -left-16 w-96 h-96 opacity-70 mix-blend-multiply" viewBox="0 0 400 400" fill="none">
            {/* Soft undulating administrative ground curves */}
            ...
            {/* Warm Amber Administrative Seal / Sun */}
            <circle cx="80" cy="150" r="40" fill="#FBBF24" className="opacity-40" />

            {/* Modern Audit Ledger Clipboard Floating Motif */}
            <rect x="65" y="165" width="65" height="90" rx="8" fill="#818CF8" />
            <rect x="80" y="157" width="35" height="14" rx="4" fill="#6366F1" />
            <line x1="77" y1="185" x2="118" y2="185" stroke="#FFFFFF" strokeWidth="3" strokeLinecap="round" />
            <line x1="77" y1="200" x2="112" y2="200" stroke="#FFFFFF" strokeWidth="3" strokeLinecap="round" />
            <line x1="77" y1="215" x2="116" y2="215" stroke="#FFFFFF" strokeWidth="3" strokeLinecap="round" />
            <line x1="77" y1="230" x2="105" y2="230" stroke="#FFFFFF" strokeWidth="3" strokeLinecap="round" />

            {/* Stylized Architectural Governance Pillars */}
            <path d="M135 190 L155 135 L175 190 Z" fill="#6366F1" />
            <path d="M170 210 L190 155 L210 210 Z" fill="#4F46E5" />
          </svg>

          {/* Right illustration: Executive Repository, Pediment Vault, Balanced Scale & Warm Sun */}
          <svg className="absolute top-32 -right-20 w-[500px] h-[500px] opacity-60 mix-blend-multiply" viewBox="0 0 500 500" fill="none">
            {/* Layered landscape curves */}
            <path d="M300 450 Q400 350 500 400 L500 500 L300 500 Z" fill="#DBEAFE" />
            <path d="M200 500 Q350 400 450 500 Z" fill="#BFDBFE" />
            <path d="M260 420 Q360 320 460 400 Z" fill="#C7D2FE" />

            {/* Administrative Oversight Vault & Columns */}
            <rect x="340" y="270" width="85" height="110" fill="#93C5FD" rx="8" />
            <path d="M330 270 L382 215 L435 270 Z" fill="#60A5FA" />
            <rect x="355" y="285" width="9" height="75" rx="2" fill="#FFFFFF" />
            <rect x="378" y="285" width="9" height="75" rx="2" fill="#FFFFFF" />
            <rect x="401" y="285" width="9" height="75" rx="2" fill="#FFFFFF" />

            {/* Golden Amber Sun */}
            <circle cx="430" cy="200" r="60" fill="#FDE047" className="opacity-30" />

            {/* Balanced Precision Scale Hanging Accent */}
            <path d="M260 300 L320 300" stroke="#818CF8" strokeWidth="5" strokeLinecap="round" />
            <line x1="290" y1="270" x2="290" y2="340" stroke="#6366F1" strokeWidth="4" strokeLinecap="round" />
            <path d="M245 330 Q260 345 275 330 Z" fill="#A5B4FC" />
            <path d="M305 330 Q320 345 335 330 Z" fill="#A5B4FC" />
            <line x1="260" y1="300" x2="245" y2="330" stroke="#818CF8" strokeWidth="2" />
            <line x1="260" y1="300" x2="275" y2="330" stroke="#818CF8" strokeWidth="2" />
            <line x1="320" y1="300" x2="305" y2="330" stroke="#818CF8" strokeWidth="2" />
            <line x1="320" y1="300" x2="335" y2="330" stroke="#818CF8" strokeWidth="2" />
          </svg>
        </>
      ) : variant === 'centre' ? (
        <>
      ...
      <div className="absolute inset-0 bg-slate-50" style={{
        maskImage: 'linear-gradient(to right, transparent 0%, transparent 12%, black 26%, black 74%, transparent 88%, transparent 100%)',
        WebkitMaskImage: 'linear-gradient(to right, transparent 0%, transparent 12%, black 26%, black 74%, transparent 88%, transparent 100%)'
      }}></div>
